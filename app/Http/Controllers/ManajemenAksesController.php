...
use App\Http\Repositories\ManajemenAksesRepository;
use App\Http\Services\ManajemenAksesServices;
use Exception;
...
class ManajemenAksesController extends Controller
{
    ...
    {
        $this->service = new ManajemenAksesServices(new ManajemenAksesRepository());
    }
    public function index()
    {
        $title = "List Akses";

        return view('pages.manajemen_akses.index', compact('title'));
    }
