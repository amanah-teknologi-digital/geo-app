        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data_pengumuman)
                ...
                ->addColumn('aksi', function ($data_pengumuman) {
                    $html = '<a href="'.route('pengumuman.edit', $data_pengumuman->id_pengumuman).'" class="btn btn-sm py-0 px-2 btn-primary"><span class="bx bx-edit-alt"></span><span class="d-none d-lg-inline-block">&nbsp;Edit</span></a>&nbsp;';
                    ...
                    if ($data_pengumuman->is_posting == 1) {
                        ...
                        //$html .= '<button class="dropdown-item btn btn-sm btn-warning batal-posting" data-id="'.$data_pengumuman->id_pengumuman.'" data-bs-toggle="modal" data-bs-target="#modal-unpost"><span class="bx bx-candles"></span><span class="d-none d-lg-inline-block">&nbsp;Unposting</span></button>';
                    }else{
                        ...
                        //$html .= '<button class="dropdown-item btn btn-sm btn-success posting-pengumuman" data-id="'.$data_pengumuman->id_pengumuman.'" data-bs-toggle="modal" data-bs-target="#modal-post"><span class="bx bx-paper-plane"></span><span class="d-none d-lg-inline-block">&nbsp;Posting</span></button>';
                    }
                    ...
                    //$html .= '<button class="dropdown-item btn btn-sm btn-danger delete-pengumuman" ><span class="bx bx-trash"></span><span class="d-none d-lg-inline-block">&nbsp;Hapus</span></button>&nbsp;';
                    $html .= '</div></div>';
                    return $html;
                })
